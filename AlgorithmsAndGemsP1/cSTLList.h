...
{
public:
	cSTLList() : containerType(eContainerType::STD_LIST) {}
	...
	std::list< sPerson > listFemaleNames;
	std::list< sPerson > listMaleNames;
	std::list< sPerson > listLastNames;
	std::list< sPerson > listGenerated;
	std::string error;
